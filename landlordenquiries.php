    ...
    <div class="main-body-content">
            ...
            <div class="advert-container1">
                ...
                <?php
                 ...
                 $select =mysqli_query($con,"SELECT * FROM advert where advert.landlord_ID=".$_SESSION['accountID']."");
    ...
    while ($row = mysqli_fetch_assoc($select)){
        ...
        ?>
                ...
                if($bathroom>1){
                    ...
                    echo"$bathroom"." bedrooms ";
                }
                else{
                    echo"%bathroom"." bedroom ";
        ...
        if  ($row['pet']){
            ...
            <div class="advert-standard-right-container-top"><img src="Image/example.png"></div>
                 <div class="advert-standard-right-container-bottom">
                <div class="advert-standard-right-container-bottom-edit" onclick="location.href= 'landlordeditproperty.php?propertyID=<?php echo $row['advert_ID']?>'" id="<?php 
                         echo"property-".$row['advert_ID'];?>"><p class="likebutton-text"><i class="fa fa-pencil-square-o  fa-2x liked" aria-hidden="true"></i><span style="padding-left:15px; font-size:25px;">Edit</span></p>
